                ...
                <div className="outlet-content">
                    {showSidebar && (<div className="profile">
                        <div className="profile__bg">
                            <img src={profileInfo.bg || "https://i.pinimg.com/736x/f9/ad/30/f9ad3071831de9aef6ebe8dd0daf508d.jpg"} alt={profileInfo.fullName + " 's cover photo"} className={"profile__bg__img " + (loading ? " skeleton-img" : "")} />
                            <button className="profile__bg__edit-btn btn btn-5" onClick={handleCoverClick}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="size-6 profile__bg__ic">
