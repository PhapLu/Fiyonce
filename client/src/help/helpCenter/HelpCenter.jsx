            ...
            <div className="help-theme">
                ...
                <div className="help-theme__content">
                    ...
                    <div className="help-theme-container">
                        ...
                        <Link to="/help-center/articles/for-talents" className="help-theme-item">
                        ...
                        <hr className="" />
                        <Link to="/help-center/articles/for-clients" className="help-theme-item">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 help-theme__ic">
                        ...
                        <hr className="" />
                        <Link to="/help-center/articles/about" className="help-theme-item">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 help-theme__ic">
