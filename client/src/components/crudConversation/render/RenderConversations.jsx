                                ...
                                <div className="user--left">
                                    ...
                                    <div className="user__name">
                                        ...
                                        <div className={`user__name__sub-title flex-align-center ${userInfo?.unSeenConversations?.some(unSeenConversation => unSeenConversation._id === conversation._id) && "fw-bold"}`}>
                                            <span>
                                                {`${conversation?.lastMember?.id === userInfo._id ? "Bạn :" : ""}`} {conversation?.lastMessage?.content ? limitString(conversation?.lastMessage?.content, 10) : (conversation?.lastMessage?.media && (conversation?.lastMessage?.senderId === userInfo._id ? "Bạn đã gửi một ảnh" : "Đã gửi một ảnh"))}
                                            </span>
