...
export default function RenderBadge({ selectedBadge, setSelectedBadge }) {
    ...
    }, [setShowRenderBadge, setOverlayVisible]);


    return (
        <div className="modal-form type-3 render-badges" ref={renderBadgeRef}>
            <h2 className="form__title">Huy hiệu</h2>
            <svg onClick={() => { setShowRenderBadge(false); setOverlayVisible(false) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="size-6 form__close-ic">
            ...
            <div className="badge-container">
                <div className={`badge-item gray-bg-hover ${selectedBadge?.isComplete ? "active" : " "}`}>
