                    ...
                    {openSubMenu == "theme" && (
                        <>
                            <div className="submenu__title">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 submenu__title__back-ic" onClick={() => { setOpenSubMenu('') }}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
                                </svg>
                                <strong className="dropdown-menu-item__title">Giao diện</strong>
                            </div>

                            <ul className="dropdown-menu-item__submenu-container">
                                <li className="dropdown-menu-item flex-justify-space-between flex-align-center" onClick={() => setTheme('light')}>
                                    <div className="flex-align-center">
                                        ...
                                        <span className="dropdown-menu-item__title">Sáng</span>
                                    </div>
                                    {
                                        theme == "light" && (
                                ...
                                <li className="dropdown-menu-item flex-justify-space-between flex-align-center" onClick={() => setTheme('dark')}>
                                    <div className="flex-align-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 mr-8">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" />
                                        </svg>
                                        <span className="dropdown-menu-item__title">Tối</span>
                                    </div>
                                    {
                                        theme == "dark" && (
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                ...
                                <hr />
                                <li className="dropdown-menu-item flex-justify-space-between flex-align-center" onClick={() => setTheme('purple')}>
                                    <div className="flex-align-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mr-8">
                                        ...
                                        <span className="dropdown-menu-item__title">Tím (Coming soon)</span>
                                    </div>
                                    {
                                        theme == "purple" && (
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                ...
                                <li className="dropdown-menu-item" onClick={() => setTheme('orange')}>
                                    ...
                                    <span className="dropdown-menu-item__title">Cam (Coming soon)</span>
                                </li>

                                <li className="dropdown-menu-item" onClick={() => setTheme('green')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mr-8">
                                    ...
                                    <span className="dropdown-menu-item__title">Xanh lá (Coming soon)</span>
                                </li>

                                <li className="dropdown-menu-item" onClick={() => setTheme('blue')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 mr-8">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 0 0 1.332-7.257 3 3 0 0 0-3.758-3.848 5.25 5.25 0 0 0-10.233 2.33A4.502 4.502 0 0 0 2.25 15Z" />
                                    </svg>
                                    <span className="dropdown-menu-item__title">Xanh da trời (Coming soon)</span>
                                </li>
                            </ul>
                        </>
                    )}
                    ...
                    {openSubMenu == "language" && (
                        <>
                            <div className="submenu__title">
                                ...
                                <strong className="dropdown-menu-item__title">Ngôn ngữ</strong>
                            </div>
                            ...
                            <ul className="dropdown-menu-item__submenu-container">
                                ...
                                <li className="dropdown-menu-item flex-justify-space-between flex-align-center" onClick={() => setLanguage('vn')}>
                                    <div className="flex-align-center">
                                        ...
                                        <span className="dropdown-menu-item__title">Tiếng Việt</span>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-6 ${language == "vn" ? "" : "opacity-0"}`}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                    </svg>
                                </li>

                                <li className="dropdown-menu-item flex-justify-space-between flex-align-center" onClick={() => setLanguage('en')}>
                                    <div className="flex-align-center">
                                        <span className="fs-12 fw-bold mr-8">EN</span>
                                        <span className="dropdown-menu-item__title">Tiếng Anh (Coming soon)</span>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-6 ${language == "en" ? "" : "opacity-0"}`}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                    </svg>
                                </li>
                            </ul>
