            ...
            <div className="render-milestones modal-form type-3" ref={renderMilestonesRef} onClick={(e) => { e.stopPropagation() }}>
                ...
                </svg>
                {
                    commissionOrder?.milestones?.length > 0 ?
                        ...
                        :
                        <p className="text-align-center mb-24">Hiện họa sĩ chưa cập nhật bản thảo cho đơn hàng này. Pastal kính chúc quý khách hàng và họa sĩ trao đổi tiến độ công việc một cách suôn sẻ nhé <span className="fs-18">😊</span></p>
                }
