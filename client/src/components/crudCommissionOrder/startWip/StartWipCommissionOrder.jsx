...
export default function StartWipCommissionOrder({ commissionOrder, setShowStartWipCommissionOrder, setOverlayVisible, startWipCommissionOrderMutation }) {

    // Return null if the commission order to be startWiped is not specified
    if (!commissionOrder) {
        return null;
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // const inputs2 = { receiverId, type: "startWipCommissionOrder", url: `/users/${commissionOrder.memberId._id}/order-history` }
