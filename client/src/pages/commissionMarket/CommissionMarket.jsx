...
export default function CommissionMarket() {
    ...
    const [showOrderCommisisonForm, setShowOrderCommissionForm] = useState(false);
        ...
        <div className="commission-market page">
            {overlayVisible && (
                <div className={`overlay`}>
                    {showOrderCommisisonForm && <OrderCommission setShowOrderCommissionForm={setShowOrderCommissionForm} setOverlayVisible={setOverlayVisible} />}
                </div>)}
            ...
            <section className="commission-market__header">
                <div className="commission-market__header--left">
                    ...
                    <br />
                    <button className="btn btn-2 btn-lg" onClick={() => { setShowOrderCommissionForm(true); setOverlayVisible(true) }}>
                    ...
                    return (
                        <div className="commission-market-item" key={indirectOrder._id}>
                            <div className="commission-market-item__header">
                                <div className="commission-market-item__header--left user">
