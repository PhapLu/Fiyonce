...
import bugReportRoute from './bugReport/index.js'
...
import accountReportRoute from './accountReport/index.js'
...
router.use('/v1/api/bugReport', bugReportRoute)
...
router.use('/v1/api/accountReport', accountReportRoute)
