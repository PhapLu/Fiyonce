...
router.get('/readProposals/:briefId', asyncHandler(proposalController.readProposals))
...
//CRUD
//Talent
router.post('/submitPortfolio/:briefId', asyncHandler(proposalController.submitPortfolio))
